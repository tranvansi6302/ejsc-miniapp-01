  ...
  return (
    <StandardPage title="Nút bấm cố định đáy">
      <div className="p-6 flex flex-col gap-6">
        <Text>Trang này kiểm tra xem nút bấm ở dưới cùng có bị thanh Home Indicator (vạch đen trên iPhone) che mất không.</Text>
      ...
      {/* Fixed Bottom Bar */}
      <div 
        className="fixed bottom-0 left-0 right-0 bg-white border-t border-slate-200 px-6 py-4 shadow-[0_-4px_20px_rgba(0,0,0,0.05)] z-[100]"
        style={{ paddingBottom: 'calc(var(--ejsc-safe-bottom) + 16px)' }}
      >
